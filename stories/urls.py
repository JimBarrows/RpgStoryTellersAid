...
urlpatterns = patterns('',
  ...
  url(r"""^(?P<story_pk>\d+)/chapter/(?P<pk>\d+)/edit$""",    ChapterEdit.as_view(),    name='chapter-edit'),
  url(r"""^(?P<story_pk>\d+)/chapter/(?P<pk>\d+)$""",         ChapterDetail.as_view(),  name='chapter-detail'),
  url(r"""^(?P<story_pk>\d+)/chapter/(?P<pk>\d+)/delete$""",  ChapterDelete.as_view(),  name='chapter-delete'),
  url(r"""^(?P<story_pk>\d+)/(?P<chapter_pk>\d+)/scene/create$""",                SceneCreate.as_view(),    name='scene-create'),
  url(r"""^(?P<story_pk>\d+)/(?P<chapter_pk>\d+)/scene/(?P<pk>\d+)/edit$""",      SceneEdit.as_view(),      name='scene-edit'),
  url(r"""^(?P<story_pk>\d+)/(?P<chapter_pk>\d+)/scene/(?P<pk>\d+)$""",           SceneDetail.as_view(),    name='scene-detail'),
  url(r"""^(?P<story_pk>\d+)/(?P<chapter_pk>\d+)/scene/(?P<pk>\d+)/delete$""",    SceneDelete.as_view(),    name='scene-delete'),
  url(r"""^(?P<story_pk>\d+)/(?P<chapter_pk>\d+)/(?P<scene_pk>\d+)clue/create$""",                 ClueCreate.as_view(),     name='clue-create'),
