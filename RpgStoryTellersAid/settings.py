"""
Django settings for RpgStoryTellersAid project.
...
SECRET_KEY = '67&lcntbu8qo-%%$!@cz_#ay%iqtbla=3+b)pe*91w*j2b48ej'
...
ROOT_URLCONF = 'RpgStoryTellersAid.urls'

WSGI_APPLICATION = 'RpgStoryTellersAid.wsgi.application'
