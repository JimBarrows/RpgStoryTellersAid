...
angular.module('storyTellersAid', [
    ...
    $routeProvider.when('/stories/new', 
												{templateUrl: 'partials/newStory.html'}),
    $routeProvider.when('/stories/edit/:id', 
												{templateUrl: 'partials/editStory.html'}),
    $routeProvider.when('/stories/edit/:id/chapters/new', 
												{templateUrl: 'partials/chapterForm.html'}),
    $routeProvider.when('/stories/edit/:id/chapters/:chapterId', 
												{templateUrl: 'partials/chapterForm.html'}),
    $routeProvider.when('/stories/new/chapters/new', 
												{templateUrl: 'partials/newChapter.html'}),
    $routeProvider.when('/stories/edit/:id/chapters/:chapterId/scenes/new', 
    ...
    $routeProvider.when('/stories/edit/:id/chapters/:chapterId/scenes/:sceneId/clues/:clueId', 
												{templateUrl: 'partials/clueForm.html'}),
